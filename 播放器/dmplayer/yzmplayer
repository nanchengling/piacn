!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        console.log("QQ26733286");
        console.log('%cwww.piacn.cn', 'font-size:2em');
        ...
        var o = function() {
          ...
          , Y = function() {
            function e(t) {
                ...
                this.options.danmaku || this.container.classList.add("yzmplayer-no-danmaku"),
                this.options.live && this.container.classList.add("yzmplayer-live"),
                c.default.isMobile && this.container.classList.add("yzmplayer-mobile"),
                ...
                this.options.danmaku && (this.danmaku = new b.default({
                    ...
                    callback: function() {
                        setTimeout(function() {
                            ...
                            if(!n.danmaku.showtips)
                            {
                            	n.danmaku.showtips = true;
                            	 if(n.danmaku.dancount == 0)
                                 {
                                 	n.danmaku.draw({
                                 	    text: '本视频还没有任何弹幕，前方安全!',
                                 	    color: '#fff',
                                 	    type: 'right',
                                 	});
                                 }
                                 ...
                                 {
                                 	n.danmaku.draw({
                                 	    text: '' + n.danmaku.dancount + '条弹幕来袭，做好战斗准备!',
                                 	    color: '#fff',
                                 	    type: 'right',
                                 	});
                                 }
          ...
          , u = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.volumeBar = this.container.querySelector(".yzmplayer-volume-bar-inner"),
                    this.volumeBarWrap = this.container.querySelector(".yzmplayer-volume-bar"),
                    this.volumeBarWrapWrap = this.container.querySelector(".yzmplayer-volume-bar-wrap"),
                    this.volumeButton = this.container.querySelector(".yzmplayer-volume"),
                    this.volumeIcon = this.container.querySelector(".yzmplayer-volume-icon .yzmplayer-icon-content"),
                    this.playedBar = this.container.querySelector(".yzmplayer-played"),
                    this.loadedBar = this.container.querySelector(".yzmplayer-loaded"),
                    this.playedBarWrap = this.container.querySelector(".yzmplayer-bar-wrap"),
                    this.playedBarTime = this.container.querySelector(".yzmplayer-bar-time"),
                    this.danmaku = this.container.querySelector(".yzmplayer-danmaku"),
                    this.danmakuLoading = this.container.querySelector(".yzmplayer-danloading"),
                    this.video = this.container.querySelector(".yzmplayer-video-current"),
                    this.bezel = this.container.querySelector(".yzmplayer-bezel-icon"),
                    this.playButton = this.container.querySelector(".yzmplayer-play-icon"),
                    this.videoWrap = this.container.querySelector(".yzmplayer-video-wrap"),
                    this.controllerMask = this.container.querySelector(".yzmplayer-controller-mask"),
                    this.ptime = this.container.querySelector(".yzmplayer-ptime"),
                    this.settingButton = this.container.querySelector(".yzmplayer-setting-icon"),
                    this.settingBox = this.container.querySelector(".yzmplayer-setting-box"),
                    this.mask = this.container.querySelector(".yzmplayer-mask"),
                    this.loop = this.container.querySelector(".yzmplayer-setting-loop"),
                    this.loopToggle = this.container.querySelector(".yzmplayer-setting-loop .yzmplayer-toggle-setting-input"),
                    this.showDanmaku = this.container.querySelector(".yzmplayer-setting-showdan"),
                    this.showDanmakuToggle = this.container.querySelector(".yzmplayer-showdan-setting-input"),
                    this.unlimitDanmaku = this.container.querySelector(".yzmplayer-setting-danunlimit"),
                    this.unlimitDanmakuToggle = this.container.querySelector(".yzmplayer-danunlimit-setting-input"),
                    this.speed = this.container.querySelector(".yzmplayer-setting-speed"),
                    this.speedItem = this.container.querySelectorAll(".yzmplayer-setting-speed-item"),
                    this.danmakuOpacityBar = this.container.querySelector(".yzmplayer-danmaku-bar-inner"),
                    this.danmakuOpacityBarWrap = this.container.querySelector(".yzmplayer-danmaku-bar"),
                    this.danmakuOpacityBarWrapWrap = this.container.querySelector(".yzmplayer-danmaku-bar-wrap"),
                    this.danmakuOpacityBox = this.container.querySelector(".yzmplayer-setting-danmaku"),
                    this.dtime = this.container.querySelector(".yzmplayer-dtime"),
                    this.controller = this.container.querySelector(".yzmplayer-controller"),
                    this.commentInput = this.container.querySelector(".yzmplayer-comment-input"),
                    this.commentButton = this.container.querySelector(".yzmplayer-comment-icon"),
                    this.yzmcomment = this.container.querySelector(".yzm-yzmplayer-comment-input"),
                    this.commentSettingBox = this.container.querySelector(".yzmplayer-comment-setting-box"),
                    this.commentSettingButton = this.container.querySelector(".yzmplayer-comment-setting-icon"),
                    this.commentSettingFill = this.container.querySelector(".yzmplayer-comment-setting-icon path"),
                    this.commentSendButton = this.container.querySelector(".yzmplayer-send-icon"),
                    this.commentSendFill = this.container.querySelector(".yzmplayer-send-icon path"),
                    this.commentColorSettingBox = this.container.querySelector(".yzmplayer-comment-setting-color"),
                    this.browserFullButton = this.container.querySelector(".yzmplayer-full-icon"),
                    this.webFullButton = this.container.querySelector(".yzmplayer-full-in-icon"),
                    this.menu = this.container.querySelector(".yzmplayer-menu"),
                    this.menuItem = this.container.querySelectorAll(".yzmplayer-menu-item"),
                    this.qualityList = this.container.querySelector(".yzmplayer-quality-list"),
                    this.camareButton = this.container.querySelector(".yzmplayer-camera-icon"),
                    this.subtitleButton = this.container.querySelector(".yzmplayer-subtitle-icon"),
                    this.subtitleButtonInner = this.container.querySelector(".yzmplayer-subtitle-icon .yzmplayer-icon-content"),
                    this.subtitle = this.container.querySelector(".yzmplayer-subtitle"),
                    this.qualityButton = this.container.querySelector(".yzmplayer-quality-icon"),
                    this.barPreview = this.container.querySelector(".yzmplayer-bar-preview"),
                    this.barWrap = this.container.querySelector(".yzmplayer-bar-wrap"),
                    this.notice = this.container.querySelector(".yzmplayer-notice"),
                    this.infoPanel = this.container.querySelector(".yzmplayer-info-panel"),
                    this.infoPanelClose = this.container.querySelector(".yzmplayer-info-panel-close"),
                    this.infoVersion = this.container.querySelector(".yzmplayer-info-panel-item-version .yzmplayer-info-panel-item-data"),
                    this.infoFPS = this.container.querySelector(".yzmplayer-info-panel-item-fps .yzmplayer-info-panel-item-data"),
                    this.infoType = this.container.querySelector(".yzmplayer-info-panel-item-type .yzmplayer-info-panel-item-data"),
                    this.infoUrl = this.container.querySelector(".yzmplayer-info-panel-item-url .yzmplayer-info-panel-item-data"),
                    this.infoResolution = this.container.querySelector(".yzmplayer-info-panel-item-resolution .yzmplayer-info-panel-item-data"),
                    this.infoDuration = this.container.querySelector(".yzmplayer-info-panel-item-duration .yzmplayer-info-panel-item-data"),
                    this.infoDanmakuId = this.container.querySelector(".yzmplayer-info-panel-item-danmaku-id .yzmplayer-info-panel-item-data"),
                    this.infoDanmakuApi = this.container.querySelector(".yzmplayer-info-panel-item-danmaku-api .yzmplayer-info-panel-item-data"),
                    this.infoDanmakuAmount = this.container.querySelector(".yzmplayer-info-panel-item-danmaku-amount .yzmplayer-info-panel-item-data")
                }
            }]),
            e
        }();
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.$value,
            e.$index;
            return t += '<div id="loading-box"><div class="loading"><p class="pic"></p><div class="tips"></div></div><div type="button" id="close" ><span id="link1">播放器已连接</span><span id="link2">弹幕正在连接中</span><span id="link2-success">弹幕已填装完毕</span><span id="link2-error">弹幕连接失败</span><span id="link3"><e id="link3_tip">等待视频连接中</e><!--d class="wait"><e id="span">3</e>s</d--></span></div></div><div class="yzmplayer-mask"></div>\n<div class="yzmplayer-cplayer"><div class="yzmplayer-showing"><img style=""  src="data:image/png;base64,"/></div></div><div class="vod-title"><div id="landing-title" class="video-info"><ul class="u-title"><a id="vodlink" href="" target="_blank" ><span class="iconfont icon-back"></span></a><a id="vodtitle"><span></span></a></ul></div></div></div><div class="yzmplayer-video-wrap">\n    ',
            function(e) {
                t += e
            }(n(4)(a)),
            t += "\n    ",
    ...
    , function(e, t, n) {
        ...
        : function(e) {
          ...
          , s = function() {
            ...
            return o(e, [{
                key: "load",
                value: function(fromtime, duration) {
                	
                	if(this.options.api.id == 'DUMMY')
                		return;
                    var e = this
                      , t = void 0;
                    t = this.options.api.address + "&id=" + this.options.api.id;
                    if(this.options.api.maximum)
                    {
                    	t = t + "&max=" + this.options.api.maximum
                    }
                    if(fromtime)
                    {
                    	t = t + "&fromtime=" + fromtime;
                    }
                    if(duration)
                    {
                    ...
                    this._readAllEndpoints(n, function(tt) {
                    	var t = tt.danmu;
                    	var resp = tt.resp;
                    	
                    	e.dancount = resp.danum;
                        e.dan = [].concat.apply(e.dan.filter(function(ee,ii,aa){return ee.time < resp.fromtime || ee.time > resp.fromtime+resp.duration}), t).sort(function(e, t) {
                        ...
                        e.options.callback(),
                        e.events && e.events.trigger("danmaku_load_end", tt)
                    })
                }
            }, {
                key: "reload",
                    ...
                    for (var n = this, i = [], a = 0, o = 0; o < e.length; ++o)
                        this.options.apiBackend.read(e[o], function(o) {
                            return function(s, d) {
                                ...
                                if (a === e.length)
                                    return t({"danmu":i,"resp":d})
                            }
                        }(o))
                }
            }, {
                key: "send",
                value: function(e, t, g) {
                    var n = {
                        ...
                        ip: this.options.tran('myself'),
                    };
                    var dm = this;
                    this.options.apiBackend.send(this.options.api.address, n, function(s,r){
                    	dm.dan.splice(dm.danIndex, 0, n),
                        dm.danIndex++;
                        var i = {
                            text: dm.htmlEncode(n.text),
                            color: n.color,
                            type: n.type,
                            size: n.size,
                            border: "2px solid " + dm.options.borderColor
                        };
                        dm.draw(i),
                        dm.events && dm.events.trigger("danmaku_send", n);
                        t && t(s,r);
                    }, g);
                }
            }, {
                ...
                value: function(e) {
                    if (void 0 !== e) {
                        for (var t = this.container.getElementsByClassName("yzmplayer-danmaku-item"), n = 0; n < t.length; n++)
                            t[n].style.opacity = e;
                        this._opacity = e,
                    ...
                    if (this.showing) {
                        ...
                        for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++)
                            !function(a) {
                                ...
                                r >= 0 && (o.classList.add("yzmplayer-danmaku-move"),
                                u.appendChild(o))
                            }(d);
                ...
                key: "resize",
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("yzmplayer-danmaku-item"), n = 0; n < t.length; n++)
        ...
        var a = function() {
          ...
          , o = function() {
            function e() {
                ...
                this.playerEvents = ["screenshot", "thumbnails_show", "thumbnails_hide", "danmaku_show", "danmaku_hide", "danmaku_clear", "danmaku_loaded", "danmaku_load_start", "danmaku_load_end", "danmaku_send", "danmaku_opacity", "contextmenu_show", "contextmenu_hide", "notice_show", "notice_hide", "quality_start", "quality_end", "destroy", "resize", "fullscreen", "fullscreen_cancel", "webfullscreen", "webfullscreen_cancel", "subtitle_show", "subtitle_hide", "subtitle_change"]
            }
            return a(e, [{
                key: "on",
                value: function(e, t) {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    case "web":
                        ...
                        document.body.classList.add("yzmplayer-web-fullscreen-fix"),
                ...
                value: function() {
                    ...
                    case "browser":
                        ...
                        break;
                    case "web":
                        this.player.container.classList.remove("yzmplayer-fulled"),
                        document.body.classList.remove("yzmplayer-web-fullscreen-fix"),
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval(function() {
                        ...
                        i || n !== t || e.player.video.paused || (e.player.container.classList.add("yzmplayer-loading"),
                        i = !0),
                        i && n > t && !e.player.video.paused && (e.player.container.classList.remove("yzmplayer-loading"),
                        i = !1),
                        t = n)
                    }, 100)
                }
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this
                      ...
                      , n = function n() {
                        document.removeEventListener(r.default.nameMap.dragEnd, n),
                        document.removeEventListener(r.default.nameMap.dragMove, t),
                        e.player.template.volumeButton.classList.remove("yzmplayer-volume-active")
                    };
                    ...
                    this.player.template.volumeBarWrapWrap.addEventListener(r.default.nameMap.dragStart, function() {
                        document.addEventListener(r.default.nameMap.dragMove, t),
                        document.addEventListener(r.default.nameMap.dragEnd, n),
                        e.player.template.volumeButton.classList.add("yzmplayer-volume-active")
                    }),
                ...
                value: function() {
                    ...
                    this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", function() {
                        ...
                        e.player.template.camareButton.download = "yzmplayer.png",
                ...
                key: "hide",
                value: function() {
                    this.player.container.classList.add("yzmplayer-hide-controller"),
          ...
          , r = function() {
            function e(t) {
                ...
                this.player.template.speed.addEventListener("click", function() {
                    n.player.template.settingBox.classList.add("yzmplayer-setting-box-narrow"),
                    n.player.template.settingBox.classList.add("yzmplayer-setting-box-speed")
                });
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                      ...
                      , r = function e() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.remove("yzmplayer-setting-danmaku-active")
                    };
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(s.default.nameMap.dragStart, function() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.add("yzmplayer-setting-danmaku-active")
                    })
                }
            }
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.player.template.mask.classList.remove("yzmplayer-mask-show"),
                    setTimeout(function() {
                ...
                key: "show",
                value: function() {
                    this.player.template.settingBox.classList.add("yzmplayer-setting-box-open"),
                    this.player.template.mask.classList.add("yzmplayer-mask-show"),
        ...
        var a = function() {
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    this.player.controller.disableAutoHide = !0,
                    this.player.template.controller.classList.add("yzmplayer-controller-comment"),
                    this.player.template.mask.classList.add("yzmplayer-mask-show"),
                    this.player.container.classList.add("yzmplayer-show-controller"),
                    this.player.template.commentInput.focus()
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.template.controller.classList.remove("yzmplayer-controller-comment"),
                    this.player.template.mask.classList.remove("yzmplayer-mask-show"),
                    this.player.container.classList.remove("yzmplayer-show-controller"),
                    this.player.controller.disableAutoHide = !1,
                    this.hideSetting()
                }
            }, {
        ...
        var o = function() {
          ...
          , s = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    this.player.template.mask.classList.remove("yzmplayer-mask-show"),
                    this.player.template.menu.classList.remove("yzmplayer-menu-show"),
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("yzmplayer-info-panel-hide")
                }
            }, {
                key: "hide",
                value: function() {
                ...
                value: function() {
                    ...
                    this.template.infoVersion.innerHTML = "1.2.0",
                    this.template.infoType.innerHTML = this.player.type,
                    this.template.infoUrl.innerHTML = this.player.videourl ? this.player.videourl : this.player.options.video.url;
                    ...
                    this.player.options.danmaku && (this.template.infoDanmakuId.innerHTML = this.player.danmakuid ? this.player.danmakuid :this.player.options.danmaku.id,
                    this.template.infoDanmakuApi.innerHTML = this.player.options.danmaku.api,
                    this.template.infoDanmakuAmount.innerHTML = this.player.danmaku.dancount)
                }
            }, {
                key: "fps",
                value: function(e) {
